...
public class CutomersUtils {
	...
	public static Customer validateCustomerDetails(String firstName, String lastName, String email, String password,
			double regAmount, String dob, String plan, List<Customer> listOfCustomers) throws CustomerException {
	...
	public static Customer logIn(String email, String password, List<Customer> listOfCustomers)
			throws CustomerException {
		Customer customer = new Customer(email);
		int index = listOfCustomers.indexOf(customer);
		if (index == -1)
			throw new CustomerException("---Email is not Registered---");
		Customer cust = listOfCustomers.get(index);
	...
	public static void checkDuplicateEmail(String email, List<Customer> listOfCustomers) throws CustomerException {
		Customer customer = new Customer(email);
