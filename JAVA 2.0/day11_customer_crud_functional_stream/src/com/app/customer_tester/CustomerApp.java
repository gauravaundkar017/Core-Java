...
//						customers.values().stream().sorted(); //impl comparable
...
//						break;
					...
					case 10:
						...
						Object readDetail = IOUtils.readDetails(sc.next());
						((Map<String, Customer>) readDetail).values().forEach(s -> System.out.println(s));
