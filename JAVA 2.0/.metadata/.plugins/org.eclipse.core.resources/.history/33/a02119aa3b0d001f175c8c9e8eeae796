...
import static com.app.customers_utils.CustomerValidations.changePassword;
import static com.app.customers_utils.CustomerValidations.populatedCustomer;
import static com.app.customers_utils.CustomerValidations.toRemoveCustomer;
import static com.app.customers_utils.CustomerValidations.toRemoveCustomerBornAfter;
import static com.app.customers_utils.CutomersUtils.logIn;
import static com.app.customers_utils.CutomersUtils.validateCustomerDetails;
